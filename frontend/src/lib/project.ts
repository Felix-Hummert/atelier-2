 ...
 * the board card, the project level and the run's trail must never disagree
 * about what the operator is looking at. It reads "atelier-2" because that is
 * this installation's actual project today — the rail's project switcher
 * (mockup v5) shows the same name.
 *
 ...
 */
export const THE_ONE_PROJECT = "atelier-2";
