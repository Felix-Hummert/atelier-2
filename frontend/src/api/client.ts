...
export const problemDefinitions = {
  ...
  "agent-platform-effect-unreconcilable": { status: 409, title: "Agent platform effect cannot be reconciled here" },
...
export const problemSchema = z.discriminatedUnion("type", [
  ...
  problemVariant("agent-platform-effect-unreconcilable", problemDefinitions["agent-platform-effect-unreconcilable"]),
