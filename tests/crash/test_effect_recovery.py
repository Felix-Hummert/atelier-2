...
def c1_expected_event_rows() -> tuple[tuple[object, ...], ...]:
    return (
        (
            "observe-0",
            "2bfd17ff6054c5469a4db9767be199b263cdad11e3a687df68272110d59ffd2b",
            1,
            V3_EFFECT_LINE_AGENT_NODE_ID,
            "a9102dec257451e2cc01d213e632beb22cc7a539cdbeb047603e7464f6afc5b8",
            "AGENT_COMPLETED",
            PROVIDER_OUTPUT,
            "10ba077a13378ab8b5b338a47169e9e0d9bbf1f746c2f45cdd9461896c0c0bb2",
            None,
            None,
            "6092727c4e61c6ecb3cd1b068434747952d6c6ac4d4ce8e7fbaf9ad6aae8592e",
        ),
        (
            "observe-0",
            "2bfd17ff6054c5469a4db9767be199b263cdad11e3a687df68272110d59ffd2b",
            2,
            V3_EFFECT_LINE_ACTION_NODE_ID,
            "6d7a30639032fb098967d63e19430121dc32f644f75a1ce7f80913bf8718550a",
            "ACTION_COMPLETED",
            ACTION_REQUEST,
            ACTION_REQUEST_HASH,
            "atelier2-node-effect-3cad09cf22f088fb152c0cf6a74d17eecd005f7f3fbfc434c2db44d30aa644c2",
            ACTION_REQUEST_HASH,
            "f34f122a681cde17eb6b405e60f9374851bd60d3803ab689e43b94defe39d5f4",
        ),
        (
            "observe-0",
            "2bfd17ff6054c5469a4db9767be199b263cdad11e3a687df68272110d59ffd2b",
            3,
            V3_EFFECT_LINE_WAIT_NODE_ID,
            "6d058f8a44b7573b753cb8c86652650d2d5efd1feeb63db9d4d4131059bdc4a4",
            "WAITING_INPUT",
            b"",
            "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
            None,
            None,
            "0b9f237cddd99bcae21839287ceda0134e53297bd3ddc7c5839ab36cc0246adb",
        ),
    )
...
def c2_expected_event_rows() -> tuple[tuple[object, ...], ...]:
    return (
        (
            ...
            1,
            V3_EFFECT_LINE_AGENT_NODE_ID,
            "d19b77d63f6c0c386f1a97e0f4cdee062079d1a96752f9f8ab0205e385d19fd9",
            "AGENT_COMPLETED",
            PROVIDER_OUTPUT,
            "10ba077a13378ab8b5b338a47169e9e0d9bbf1f746c2f45cdd9461896c0c0bb2",
            None,
            None,
            "c6e6fcc28dd05894c4bb20dbf8d356e4853fb256b7b44ed417ec62d5c21e7953",
        ),
        (
            "c2-after-external-commit",
            "2bfd17ff6054c5469a4db9767be199b263cdad11e3a687df68272110d59ffd2b",
            2,
            V3_EFFECT_LINE_ACTION_NODE_ID,
            "791c2da78745a04d3d6106e3d79c6fe001da826a7724eba08149babe86b87d5d",
            "ACTION_COMPLETED",
            ACTION_REQUEST,
            ACTION_REQUEST_HASH,
            "atelier2-node-effect-c3007f476c1b77b6ecf34d7bcc4eb35e59bd3754c7e7c48b8bd882ddfe95c992",
            ACTION_REQUEST_HASH,
            "09d23e28ede48afd4331ed33e860600d7535cfe6fe55db1479e6560de20f2347",
        ),
        (
            "c2-after-external-commit",
            "2bfd17ff6054c5469a4db9767be199b263cdad11e3a687df68272110d59ffd2b",
            3,
            V3_EFFECT_LINE_WAIT_NODE_ID,
            "71a674e66f3ba42a2cb77c8e3745b48fc5ae9ddcf5eb64d936947e7526fe8558",
            "WAITING_INPUT",
            b"",
            "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
            None,
            None,
            "beab1c3a91571768de83fbac91483a4218cbbbbea8ba4bf281292c4b361c76cb",
        ),
    )
