...
EXPECTED_PATHS = {
    ...
    API_PREFIX + "/projects",
    API_PREFIX + "/projects/{project_id}",
    API_PREFIX + "/runs",
...
EXPECTED_ROUTE_SEQUENCE = (
    ...
    ("POST", API_PREFIX + "/projects", "create_project_route"),
    ("GET", API_PREFIX + "/projects", "list_projects_route"),
    ("GET", API_PREFIX + "/projects/{project_id}", "get_project_route"),
...
EXPECTED_SUCCESS_STATUSES = {
    ...
    (API_PREFIX + "/projects", "post"): {"201"},
    (API_PREFIX + "/projects", "get"): {"200"},
    (API_PREFIX + "/projects/{project_id}", "get"): {"200"},
