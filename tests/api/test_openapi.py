...
def test_served_document_is_byte_identical_to_the_frozen_artefact() -> None:
    ...
    The artefact was last regenerated when the V3 graph grew the declared
    orders (name plus the schema reference the author pinned) on the existing
    detail resource. That regeneration is the wire change this head declares;
