...
This directory owns only the Journey→Requirement illustration edge. The
requirement, revision, and acceptance contracts live in
...
- A journey illustrates; it does not bind or invent product truth.
