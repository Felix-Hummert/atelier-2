...
- [ADR 0020: One Runner-owned session port carries every provider; a permission is authorisation, and the transcript is its projection](0020-provider-boundary.md)
