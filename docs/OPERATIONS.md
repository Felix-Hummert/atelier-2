...
unaltered. The built steps start at schema version 13; which versions can be
raised is what the command reports, and [ADR 0001](decisions/0001-durable-runtime.md)
records what each step did. Older published predecessors, and unknown or future
