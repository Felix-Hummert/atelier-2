...
Begründung: Der Studio-Beleg trägt Leer, lädt und Fehler für seinen vollständigen Fünf-Listen-Read. Diese Regel verlangt weiterhin, dass die vier Zustände nicht ineinanderfallen.
Journeys:
Beweis:     the-studio-preserves-confirmed-truth-and-retries-only-its-failed-read
Offen:      - Project und New Run sowie der eigene Zustand „wartet“ (Eigentümer: #440 für die Read-Flächen; „wartet“ derzeit ungebunden)
...
- REQ-UIQ-06: `the-studio-preserves-confirmed-truth-and-retries-only-its-failed-read`
